            ...
            <table cellspacing="0" style="width: 100%">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="el-table__cell is-leaf">
                    <div class="cell" v-if="server.py">{{ server.py.total }}</div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="el-table__cell is-leaf">
                    <div class="cell" v-if="server.py">{{ server.py.used }}</div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="el-table__cell is-leaf">
                    <div class="cell" v-if="server.py">{{ server.py.free }}</div>
                  </td>
                </tr>
                <tr>
            ...
            <table cellspacing="0" style="width: 100%; table-layout: fixed">
              <tbody>
                <tr>
                  ...
                  <td class="el-table__cell is-leaf">
                    <div class="cell" v-if="server.py">{{ server.py.name }}</div>
                  </td>
                  <td class="el-table__cell is-leaf"><div class="cell">Python版本</div></td>
                  <td class="el-table__cell is-leaf">
                    <div class="cell" v-if="server.py">{{ server.py.version }}</div>
                  </td>
                </tr>
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">启动时间</div></td>
                  <td class="el-table__cell is-leaf">
                    <div class="cell" v-if="server.py">{{ server.py.startTime }}</div>
                  </td>
                  <td class="el-table__cell is-leaf"><div class="cell">运行时长</div></td>
                  <td class="el-table__cell is-leaf">
                    <div class="cell" v-if="server.py">{{ server.py.runTime }}</div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td colspan="3" class="el-table__cell is-leaf">
                    <div class="cell" v-if="server.py">{{ server.py.home }}</div>
                  </td>
                </tr>
                <tr>
                  <td colspan="1" class="el-table__cell is-leaf">
