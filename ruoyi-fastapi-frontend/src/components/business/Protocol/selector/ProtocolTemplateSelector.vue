...
const emit = defineEmits<{ 'update:modelValue': [value: string | number | null], change: [value: string | number | null], 'entity-change': [entity: any], entity: [entity: any] }>()
